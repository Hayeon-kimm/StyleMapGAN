...
os.environ['CUDA_VISIBLE_DEVICSE'] = "0,5,6,7"
...
from torchinfo import summary #torch_summary
...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch", type=int, default=10, help="total batch sizes")
